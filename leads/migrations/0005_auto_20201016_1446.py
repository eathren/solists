...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='lead',
            name='experience',
            field=multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('Junior', 'Junior'), ('Intermediate', 'Intermediate'), ('Senior', 'Senior'), ('Intern', 'Intern')], max_length=200),
        ),
        migrations.AddField(
            model_name='lead',
            name='job_type',
            field=multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('Full-time', 'Full-time'), ('Part-time', 'Part-time'), ('Contract', 'Contract'), ('Internship', 'Internship')], max_length=200),
        ),
        migrations.AddField(
            model_name='lead',
            name='remote',
            field=multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('Remote', 'Remote'), ('Part-Remote', 'Part-Remote'), ('Non-Remote', 'Non-Remote')], max_length=200),
        ),
        migrations.AddField(
            model_name='lead',
            name='role',
            field=multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('Developer', 'Developer'), ('Designer', 'Designer')], max_length=200),
        ),
        migrations.AddField(
            model_name='lead',
            name='skills',
